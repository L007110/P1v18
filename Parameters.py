...
# === P1v18: Final Optimized Reward Ablation ===
# ==========================================

# 1. 最佳权重配置 (来自 P1v17 Grid Search 冠军结果)
# 这一步固化了我们的最优发现，不再变动
SNR_MULTIPLIER = 1.0
V2I_MULTIPLIER = 0.0  # 适度的利他性
DELAY_MULTIPLIER = 1.0 # 降低延迟权重的噪声干扰
POWER_MULTIPLIER = 1.0 # 默认保留

# 2. 归一化窗口 (保持 P1v17 的成功设定)
REWARD_RUNNING_WINDOW = 2000

# 3. 消融模式 (Ablation Mode) - 由 Main.py 动态修改
# E0: Baseline (Full Optimized Reward)
# E1: No V2I Penalty (测试利他性)
# E2: No Delay Reward (测试时延敏感度)
# E3: Only SNR (贪婪策略基准)
ABLATION_MODE = "E0"

# 4. 自动生成后缀
ABLATION_SUFFIX = f"_P1v18_{ABLATION_MODE}"
